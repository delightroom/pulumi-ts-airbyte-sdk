...
export class SourceInsightly extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceInsightlyState, opts?: pulumi.CustomResourceOptions): SourceInsightly {
        return new SourceInsightly(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceInsightly:SourceInsightly';

    /**
     * Returns true if the given object is an instance of SourceInsightly.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceInsightly {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceInsightly.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceInsightlyConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceInsightlyResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceInsightlyArgs | SourceInsightlyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceInsightlyState | undefined;
            ...
            const args = argsOrState as SourceInsightlyArgs | undefined;
        ...
        super(SourceInsightly.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
