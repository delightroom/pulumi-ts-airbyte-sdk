...
export class SourceGithub extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceGithubState, opts?: pulumi.CustomResourceOptions): SourceGithub {
        return new SourceGithub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceGithub:SourceGithub';

    /**
     * Returns true if the given object is an instance of SourceGithub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceGithub {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceGithub.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceGithubConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceGithubResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceGithubArgs | SourceGithubState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceGithubState | undefined;
            ...
            const args = argsOrState as SourceGithubArgs | undefined;
        ...
        super(SourceGithub.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
