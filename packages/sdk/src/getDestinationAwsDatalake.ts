...
export function getDestinationAwsDatalakeOutput(args: GetDestinationAwsDatalakeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationAwsDatalakeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
