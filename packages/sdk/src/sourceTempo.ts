...
export class SourceTempo extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTempoState, opts?: pulumi.CustomResourceOptions): SourceTempo {
        return new SourceTempo(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceTempo:SourceTempo';

    /**
     * Returns true if the given object is an instance of SourceTempo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceTempo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceTempo.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceTempoConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceTempoResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceTempoArgs | SourceTempoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceTempoState | undefined;
            ...
            const args = argsOrState as SourceTempoArgs | undefined;
        ...
        super(SourceTempo.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
