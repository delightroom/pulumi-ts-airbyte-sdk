...
export class SourceAzureBlobStorage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAzureBlobStorageState, opts?: pulumi.CustomResourceOptions): SourceAzureBlobStorage {
        return new SourceAzureBlobStorage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceAzureBlobStorage:SourceAzureBlobStorage';

    /**
     * Returns true if the given object is an instance of SourceAzureBlobStorage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceAzureBlobStorage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceAzureBlobStorage.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SourceAzureBlobStorageArgs | SourceAzureBlobStorageState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as SourceAzureBlobStorageArgs | undefined;
        ...
        super(SourceAzureBlobStorage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
