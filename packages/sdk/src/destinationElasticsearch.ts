...
export class DestinationElasticsearch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationElasticsearchState, opts?: pulumi.CustomResourceOptions): DestinationElasticsearch {
        return new DestinationElasticsearch(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationElasticsearch:DestinationElasticsearch';

    /**
     * Returns true if the given object is an instance of DestinationElasticsearch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationElasticsearch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationElasticsearch.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationElasticsearchConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationElasticsearchResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationElasticsearchArgs | DestinationElasticsearchState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationElasticsearchState | undefined;
            ...
            const args = argsOrState as DestinationElasticsearchArgs | undefined;
        ...
        super(DestinationElasticsearch.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
