...
export class SourceNetsuite extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceNetsuiteState, opts?: pulumi.CustomResourceOptions): SourceNetsuite {
        return new SourceNetsuite(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceNetsuite:SourceNetsuite';

    /**
     * Returns true if the given object is an instance of SourceNetsuite.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceNetsuite {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceNetsuite.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceNetsuiteConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceNetsuiteResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceNetsuiteArgs | SourceNetsuiteState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceNetsuiteState | undefined;
            ...
            const args = argsOrState as SourceNetsuiteArgs | undefined;
        ...
        super(SourceNetsuite.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
