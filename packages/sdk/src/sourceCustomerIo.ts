...
export class SourceCustomerIo extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceCustomerIoState, opts?: pulumi.CustomResourceOptions): SourceCustomerIo {
        return new SourceCustomerIo(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceCustomerIo:SourceCustomerIo';

    /**
     * Returns true if the given object is an instance of SourceCustomerIo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceCustomerIo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceCustomerIo.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceCustomerIoConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceCustomerIoResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceCustomerIoArgs | SourceCustomerIoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceCustomerIoState | undefined;
            ...
            const args = argsOrState as SourceCustomerIoArgs | undefined;
        ...
        super(SourceCustomerIo.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
