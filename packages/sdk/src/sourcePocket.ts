...
export class SourcePocket extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourcePocketState, opts?: pulumi.CustomResourceOptions): SourcePocket {
        return new SourcePocket(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourcePocket:SourcePocket';

    /**
     * Returns true if the given object is an instance of SourcePocket.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourcePocket {
    ...
    public readonly configuration!: pulumi.Output<outputs.SourcePocketConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourcePocketResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourcePocketArgs | SourcePocketState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourcePocketState | undefined;
            ...
            const args = argsOrState as SourcePocketArgs | undefined;
