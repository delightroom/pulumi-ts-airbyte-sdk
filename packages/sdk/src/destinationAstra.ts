...
export class DestinationAstra extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationAstraState, opts?: pulumi.CustomResourceOptions): DestinationAstra {
        return new DestinationAstra(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationAstra:DestinationAstra';

    /**
     * Returns true if the given object is an instance of DestinationAstra.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationAstra {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationAstra.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.DestinationAstraConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationAstraResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationAstraArgs | DestinationAstraState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationAstraState | undefined;
            ...
            const args = argsOrState as DestinationAstraArgs | undefined;
        ...
        super(DestinationAstra.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
