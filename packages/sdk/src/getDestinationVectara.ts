...
export function getDestinationVectaraOutput(args: GetDestinationVectaraOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationVectaraResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
