...
export function getSourceSapFieldglassOutput(args: GetSourceSapFieldglassOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceSapFieldglassResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
