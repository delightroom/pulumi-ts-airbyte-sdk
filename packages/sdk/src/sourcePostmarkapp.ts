...
export class SourcePostmarkapp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourcePostmarkappState, opts?: pulumi.CustomResourceOptions): SourcePostmarkapp {
        return new SourcePostmarkapp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourcePostmarkapp:SourcePostmarkapp';

    /**
     * Returns true if the given object is an instance of SourcePostmarkapp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourcePostmarkapp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourcePostmarkapp.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourcePostmarkappConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourcePostmarkappResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourcePostmarkappArgs | SourcePostmarkappState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourcePostmarkappState | undefined;
            ...
            const args = argsOrState as SourcePostmarkappArgs | undefined;
        ...
        super(SourcePostmarkapp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
