...
export class DestinationPgvector extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationPgvectorState, opts?: pulumi.CustomResourceOptions): DestinationPgvector {
        return new DestinationPgvector(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationPgvector:DestinationPgvector';

    /**
     * Returns true if the given object is an instance of DestinationPgvector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationPgvector {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationPgvector.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.DestinationPgvectorConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationPgvectorResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationPgvectorArgs | DestinationPgvectorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationPgvectorState | undefined;
            ...
            const args = argsOrState as DestinationPgvectorArgs | undefined;
        ...
        super(DestinationPgvector.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
