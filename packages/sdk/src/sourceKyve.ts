...
export class SourceKyve extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceKyveState, opts?: pulumi.CustomResourceOptions): SourceKyve {
        return new SourceKyve(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceKyve:SourceKyve';

    /**
     * Returns true if the given object is an instance of SourceKyve.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceKyve {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceKyve.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceKyveConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceKyveResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceKyveArgs | SourceKyveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceKyveState | undefined;
            ...
            const args = argsOrState as SourceKyveArgs | undefined;
        ...
        super(SourceKyve.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
