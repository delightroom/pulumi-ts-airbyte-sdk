...
export declare class SourceMonday extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMondayState, opts?: pulumi.CustomResourceOptions): SourceMonday;
    /**
     * Returns true if the given object is an instance of SourceMonday.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceMonday;
    readonly configuration: pulumi.Output<outputs.SourceMondayConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceMondayResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceMondayArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceMonday resources.
 */
export interface SourceMondayState {
    configuration?: pulumi.Input<inputs.SourceMondayConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceMondayResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceMondayArgs {
    configuration: pulumi.Input<inputs.SourceMondayConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
