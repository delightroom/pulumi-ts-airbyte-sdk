...
export declare class DestinationTimeplus extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationTimeplusState, opts?: pulumi.CustomResourceOptions): DestinationTimeplus;
    /**
     * Returns true if the given object is an instance of DestinationTimeplus.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationTimeplus;
    readonly configuration: pulumi.Output<outputs.DestinationTimeplusConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationTimeplusResourceAllocation>;
...
export interface DestinationTimeplusState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationTimeplusResourceAllocation>;
