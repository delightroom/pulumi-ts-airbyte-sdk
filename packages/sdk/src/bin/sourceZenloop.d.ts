...
export declare class SourceZenloop extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceZenloopState, opts?: pulumi.CustomResourceOptions): SourceZenloop;
    /**
     * Returns true if the given object is an instance of SourceZenloop.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceZenloop;
    readonly configuration: pulumi.Output<outputs.SourceZenloopConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceZenloopResourceAllocation>;
    /**
...
export interface SourceZenloopState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceZenloopResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
