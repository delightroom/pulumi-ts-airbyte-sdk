...
export declare class SourcePostgres extends pulumi.CustomResource {
    ...
    readonly configuration: pulumi.Output<outputs.SourcePostgresConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourcePostgresResourceAllocation>;
    /**
...
export interface SourcePostgresState {
    configuration?: pulumi.Input<inputs.SourcePostgresConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourcePostgresResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
