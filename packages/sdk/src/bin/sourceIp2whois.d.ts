...
export declare class SourceIp2whois extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceIp2whoisState, opts?: pulumi.CustomResourceOptions): SourceIp2whois;
    /**
     * Returns true if the given object is an instance of SourceIp2whois.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceIp2whois;
    readonly configuration: pulumi.Output<outputs.SourceIp2whoisConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceIp2whoisResourceAllocation>;
    /**
    ...
    /**
     * Create a SourceIp2whois resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SourceIp2whoisArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceIp2whois resources.
 */
export interface SourceIp2whoisState {
    configuration?: pulumi.Input<inputs.SourceIp2whoisConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceIp2whoisResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceIp2whoisArgs {
    configuration: pulumi.Input<inputs.SourceIp2whoisConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
