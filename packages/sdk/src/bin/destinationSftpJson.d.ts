...
export declare class DestinationSftpJson extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationSftpJsonResourceAllocation>;
...
export interface DestinationSftpJsonState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationSftpJsonResourceAllocation>;
