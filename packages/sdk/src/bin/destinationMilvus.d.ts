...
export declare class DestinationMilvus extends pulumi.CustomResource {
    /**
     * Get an existing DestinationMilvus resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationMilvusState, opts?: pulumi.CustomResourceOptions): DestinationMilvus;
    /**
     * Returns true if the given object is an instance of DestinationMilvus.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationMilvus;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.DestinationMilvusConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationMilvusResourceAllocation>;
    readonly workspaceId: pulumi.Output<string>;
    /**
     * Create a DestinationMilvus resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DestinationMilvusArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering DestinationMilvus resources.
 */
export interface DestinationMilvusState {
    /**
     * The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
     * configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
     * model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
     ...
     * indexing configuration is provided by the destination connector in the sub class.
     */
    configuration?: pulumi.Input<inputs.DestinationMilvusConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationMilvusResourceAllocation>;
    workspaceId?: pulumi.Input<string>;
}
/**
 * The set of arguments for constructing a DestinationMilvus resource.
 */
export interface DestinationMilvusArgs {
    /**
     * The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
     * configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
     * model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
