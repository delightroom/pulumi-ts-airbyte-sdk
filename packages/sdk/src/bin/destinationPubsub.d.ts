...
export declare class DestinationPubsub extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationPubsubResourceAllocation>;
...
export interface DestinationPubsubState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationPubsubResourceAllocation>;
