...
export declare class DestinationAzureBlobStorage extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationAzureBlobStorageResourceAllocation>;
...
export interface DestinationAzureBlobStorageState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationAzureBlobStorageResourceAllocation>;
