...
exports.getSourceFauna = getSourceFauna;
exports.getSourceFaunaOutput = getSourceFaunaOutput;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
function getSourceFauna(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("airbyte:index/getSourceFauna:getSourceFauna", {
        "sourceId": args.sourceId,
    }, opts, utilities.getPackage());
}
function getSourceFaunaOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
