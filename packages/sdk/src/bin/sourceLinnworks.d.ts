...
export declare class SourceLinnworks extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceLinnworksState, opts?: pulumi.CustomResourceOptions): SourceLinnworks;
    /**
     * Returns true if the given object is an instance of SourceLinnworks.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceLinnworks;
    readonly configuration: pulumi.Output<outputs.SourceLinnworksConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceLinnworksResourceAllocation>;
    /**
...
export interface SourceLinnworksState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceLinnworksResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
