...
export declare class SourceNytimes extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceNytimesState, opts?: pulumi.CustomResourceOptions): SourceNytimes;
    /**
     * Returns true if the given object is an instance of SourceNytimes.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceNytimes;
    readonly configuration: pulumi.Output<outputs.SourceNytimesConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceNytimesResourceAllocation>;
    /**
...
export interface SourceNytimesState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceNytimesResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
