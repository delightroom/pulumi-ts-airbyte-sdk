...
export declare class SourceS3 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceS3State, opts?: pulumi.CustomResourceOptions): SourceS3;
    /**
     * Returns true if the given object is an instance of SourceS3.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceS3;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.SourceS3Configuration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceS3ResourceAllocation>;
    /**
...
export interface SourceS3State {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceS3ResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
