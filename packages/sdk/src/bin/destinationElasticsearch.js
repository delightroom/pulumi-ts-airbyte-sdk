...
exports.DestinationElasticsearch = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationElasticsearch extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationElasticsearch(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.DestinationElasticsearch = DestinationElasticsearch;
/** @internal */
DestinationElasticsearch.__pulumiType = 'airbyte:index/destinationElasticsearch:DestinationElasticsearch';
//# sourceMappingURL=destinationElasticsearch.js.map