...
export declare class SourceTodoist extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTodoistState, opts?: pulumi.CustomResourceOptions): SourceTodoist;
    /**
     * Returns true if the given object is an instance of SourceTodoist.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceTodoist;
    readonly configuration: pulumi.Output<outputs.SourceTodoistConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceTodoistResourceAllocation>;
    /**
...
export interface SourceTodoistState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceTodoistResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
