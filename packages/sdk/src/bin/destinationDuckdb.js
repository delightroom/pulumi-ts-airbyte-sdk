...
exports.DestinationDuckdb = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationDuckdb extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationDuckdb(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.DestinationDuckdb = DestinationDuckdb;
/** @internal */
DestinationDuckdb.__pulumiType = 'airbyte:index/destinationDuckdb:DestinationDuckdb';
//# sourceMappingURL=destinationDuckdb.js.map