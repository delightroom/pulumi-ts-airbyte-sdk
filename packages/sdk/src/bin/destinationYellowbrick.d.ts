...
export declare class DestinationYellowbrick extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationYellowbrickState, opts?: pulumi.CustomResourceOptions): DestinationYellowbrick;
    /**
     * Returns true if the given object is an instance of DestinationYellowbrick.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationYellowbrick;
    readonly configuration: pulumi.Output<outputs.DestinationYellowbrickConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationYellowbrickResourceAllocation>;
    readonly workspaceId: pulumi.Output<string>;
    /**
     * Create a DestinationYellowbrick resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DestinationYellowbrickArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering DestinationYellowbrick resources.
 */
export interface DestinationYellowbrickState {
    configuration?: pulumi.Input<inputs.DestinationYellowbrickConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationYellowbrickResourceAllocation>;
    workspaceId?: pulumi.Input<string>;
}
/**
 * The set of arguments for constructing a DestinationYellowbrick resource.
 */
export interface DestinationYellowbrickArgs {
    configuration: pulumi.Input<inputs.DestinationYellowbrickConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
     * replacement if changed.
