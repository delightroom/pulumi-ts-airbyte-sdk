...
export declare class SourceAircall extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAircallState, opts?: pulumi.CustomResourceOptions): SourceAircall;
    /**
     * Returns true if the given object is an instance of SourceAircall.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceAircall;
    readonly configuration: pulumi.Output<outputs.SourceAircallConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceAircallResourceAllocation>;
    /**
    ...
    /**
     * Create a SourceAircall resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SourceAircallArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceAircall resources.
 */
export interface SourceAircallState {
    configuration?: pulumi.Input<inputs.SourceAircallConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceAircallResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceAircallArgs {
    configuration: pulumi.Input<inputs.SourceAircallConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
