...
export declare class SourceK6Cloud extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceK6CloudState, opts?: pulumi.CustomResourceOptions): SourceK6Cloud;
    /**
     * Returns true if the given object is an instance of SourceK6Cloud.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceK6Cloud;
    readonly configuration: pulumi.Output<outputs.SourceK6CloudConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceK6CloudResourceAllocation>;
    /**
    ...
    /**
     * Create a SourceK6Cloud resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SourceK6CloudArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceK6Cloud resources.
 */
export interface SourceK6CloudState {
    configuration?: pulumi.Input<inputs.SourceK6CloudConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceK6CloudResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceK6CloudArgs {
    configuration: pulumi.Input<inputs.SourceK6CloudConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
