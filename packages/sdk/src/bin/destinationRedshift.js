...
exports.DestinationRedshift = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationRedshift extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationRedshift(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(DestinationRedshift.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.DestinationRedshift = DestinationRedshift;
/** @internal */
DestinationRedshift.__pulumiType = 'airbyte:index/destinationRedshift:DestinationRedshift';
//# sourceMappingURL=destinationRedshift.js.map