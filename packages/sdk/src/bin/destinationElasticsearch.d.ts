...
export declare class DestinationElasticsearch extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationElasticsearchResourceAllocation>;
...
export interface DestinationElasticsearchState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationElasticsearchResourceAllocation>;
