...
export declare class SourceTwitter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTwitterState, opts?: pulumi.CustomResourceOptions): SourceTwitter;
    /**
     * Returns true if the given object is an instance of SourceTwitter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceTwitter;
    readonly configuration: pulumi.Output<outputs.SourceTwitterConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceTwitterResourceAllocation>;
    /**
...
export interface SourceTwitterState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceTwitterResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
