...
export declare class SourceDynamodb extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceDynamodbState, opts?: pulumi.CustomResourceOptions): SourceDynamodb;
    /**
     * Returns true if the given object is an instance of SourceDynamodb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceDynamodb;
    readonly configuration: pulumi.Output<outputs.SourceDynamodbConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceDynamodbResourceAllocation>;
    /**
...
export interface SourceDynamodbState {
    configuration?: pulumi.Input<inputs.SourceDynamodbConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceDynamodbResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
