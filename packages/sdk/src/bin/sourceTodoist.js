...
exports.SourceTodoist = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourceTodoist extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourceTodoist(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(SourceTodoist.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.SourceTodoist = SourceTodoist;
/** @internal */
SourceTodoist.__pulumiType = 'airbyte:index/sourceTodoist:SourceTodoist';
//# sourceMappingURL=sourceTodoist.js.map