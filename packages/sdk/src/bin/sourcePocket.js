...
exports.SourcePocket = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourcePocket extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourcePocket(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.SourcePocket = SourcePocket;
/** @internal */
