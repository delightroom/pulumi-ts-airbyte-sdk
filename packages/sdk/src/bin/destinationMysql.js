...
exports.DestinationMysql = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationMysql extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationMysql(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(DestinationMysql.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.DestinationMysql = DestinationMysql;
/** @internal */
DestinationMysql.__pulumiType = 'airbyte:index/destinationMysql:DestinationMysql';
//# sourceMappingURL=destinationMysql.js.map