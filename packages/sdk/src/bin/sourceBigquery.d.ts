...
export declare class SourceBigquery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceBigqueryState, opts?: pulumi.CustomResourceOptions): SourceBigquery;
    /**
     * Returns true if the given object is an instance of SourceBigquery.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceBigquery;
    readonly configuration: pulumi.Output<outputs.SourceBigqueryConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceBigqueryResourceAllocation>;
    /**
...
export interface SourceBigqueryState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceBigqueryResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
