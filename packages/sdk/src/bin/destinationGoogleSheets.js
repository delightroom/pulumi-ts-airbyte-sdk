...
exports.DestinationGoogleSheets = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationGoogleSheets extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationGoogleSheets(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(DestinationGoogleSheets.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.DestinationGoogleSheets = DestinationGoogleSheets;
/** @internal */
DestinationGoogleSheets.__pulumiType = 'airbyte:index/destinationGoogleSheets:DestinationGoogleSheets';
//# sourceMappingURL=destinationGoogleSheets.js.map