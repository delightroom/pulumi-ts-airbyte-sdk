...
exports.SourceTwitter = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourceTwitter extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourceTwitter(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(SourceTwitter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.SourceTwitter = SourceTwitter;
/** @internal */
SourceTwitter.__pulumiType = 'airbyte:index/sourceTwitter:SourceTwitter';
//# sourceMappingURL=sourceTwitter.js.map