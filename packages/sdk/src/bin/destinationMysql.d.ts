...
export declare class DestinationMysql extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationMysqlState, opts?: pulumi.CustomResourceOptions): DestinationMysql;
    /**
     * Returns true if the given object is an instance of DestinationMysql.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationMysql;
    readonly configuration: pulumi.Output<outputs.DestinationMysqlConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationMysqlResourceAllocation>;
...
export interface DestinationMysqlState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationMysqlResourceAllocation>;
