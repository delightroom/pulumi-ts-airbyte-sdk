...
export declare class SourceSapFieldglass extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceSapFieldglassState, opts?: pulumi.CustomResourceOptions): SourceSapFieldglass;
    /**
     * Returns true if the given object is an instance of SourceSapFieldglass.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceSapFieldglass;
    readonly configuration: pulumi.Output<outputs.SourceSapFieldglassConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceSapFieldglassResourceAllocation>;
    /**
...
export interface SourceSapFieldglassState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceSapFieldglassResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
