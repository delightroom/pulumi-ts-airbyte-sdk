...
export declare class SourceYoutubeAnalytics extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceYoutubeAnalyticsResourceAllocation>;
    /**
...
export interface SourceYoutubeAnalyticsState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceYoutubeAnalyticsResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
