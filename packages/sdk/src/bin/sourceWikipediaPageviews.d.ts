...
export declare class SourceWikipediaPageviews extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceWikipediaPageviewsState, opts?: pulumi.CustomResourceOptions): SourceWikipediaPageviews;
    /**
     * Returns true if the given object is an instance of SourceWikipediaPageviews.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceWikipediaPageviews;
    readonly configuration: pulumi.Output<outputs.SourceWikipediaPageviewsConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceWikipediaPageviewsResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceWikipediaPageviewsArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceWikipediaPageviews resources.
 */
export interface SourceWikipediaPageviewsState {
    configuration?: pulumi.Input<inputs.SourceWikipediaPageviewsConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceWikipediaPageviewsResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceWikipediaPageviewsArgs {
    configuration: pulumi.Input<inputs.SourceWikipediaPageviewsConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
