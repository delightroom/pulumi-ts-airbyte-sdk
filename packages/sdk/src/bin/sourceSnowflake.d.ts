...
export declare class SourceSnowflake extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceSnowflakeState, opts?: pulumi.CustomResourceOptions): SourceSnowflake;
    /**
     * Returns true if the given object is an instance of SourceSnowflake.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceSnowflake;
    readonly configuration: pulumi.Output<outputs.SourceSnowflakeConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceSnowflakeResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceSnowflakeArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceSnowflake resources.
 */
export interface SourceSnowflakeState {
    configuration?: pulumi.Input<inputs.SourceSnowflakeConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceSnowflakeResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceSnowflakeArgs {
    configuration: pulumi.Input<inputs.SourceSnowflakeConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
