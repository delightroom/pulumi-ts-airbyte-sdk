...
export declare class DestinationDevNull extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationDevNullState, opts?: pulumi.CustomResourceOptions): DestinationDevNull;
    /**
     * Returns true if the given object is an instance of DestinationDevNull.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationDevNull;
    readonly configuration: pulumi.Output<outputs.DestinationDevNullConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationDevNullResourceAllocation>;
...
export interface DestinationDevNullState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationDevNullResourceAllocation>;
