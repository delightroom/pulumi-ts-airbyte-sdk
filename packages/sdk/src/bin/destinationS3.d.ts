...
export declare class DestinationS3 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationS3State, opts?: pulumi.CustomResourceOptions): DestinationS3;
    /**
     * Returns true if the given object is an instance of DestinationS3.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationS3;
    readonly configuration: pulumi.Output<outputs.DestinationS3Configuration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationS3ResourceAllocation>;
     ...
     */
    constructor(name: string, args: DestinationS3Args, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering DestinationS3 resources.
 */
export interface DestinationS3State {
    configuration?: pulumi.Input<inputs.DestinationS3Configuration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationS3ResourceAllocation>;
    workspaceId?: pulumi.Input<string>;
}
/**
 * The set of arguments for constructing a DestinationS3 resource.
 */
export interface DestinationS3Args {
    configuration: pulumi.Input<inputs.DestinationS3Configuration>;
    /**
     * The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
     * replacement if changed.
