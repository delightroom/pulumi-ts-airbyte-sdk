...
exports.SourceTwilio = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourceTwilio extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourceTwilio(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(SourceTwilio.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.SourceTwilio = SourceTwilio;
/** @internal */
SourceTwilio.__pulumiType = 'airbyte:index/sourceTwilio:SourceTwilio';
//# sourceMappingURL=sourceTwilio.js.map