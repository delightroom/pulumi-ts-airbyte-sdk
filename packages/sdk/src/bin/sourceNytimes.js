...
exports.SourceNytimes = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourceNytimes extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourceNytimes(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(SourceNytimes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.SourceNytimes = SourceNytimes;
/** @internal */
SourceNytimes.__pulumiType = 'airbyte:index/sourceNytimes:SourceNytimes';
//# sourceMappingURL=sourceNytimes.js.map