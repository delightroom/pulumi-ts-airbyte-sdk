...
export declare class SourceBambooHr extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceBambooHrState, opts?: pulumi.CustomResourceOptions): SourceBambooHr;
    /**
     * Returns true if the given object is an instance of SourceBambooHr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceBambooHr;
    readonly configuration: pulumi.Output<outputs.SourceBambooHrConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceBambooHrResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceBambooHrArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceBambooHr resources.
 */
export interface SourceBambooHrState {
    configuration?: pulumi.Input<inputs.SourceBambooHrConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceBambooHrResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceBambooHrArgs {
    configuration: pulumi.Input<inputs.SourceBambooHrConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
