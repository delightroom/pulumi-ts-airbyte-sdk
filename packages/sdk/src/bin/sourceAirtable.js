...
exports.SourceAirtable = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourceAirtable extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourceAirtable(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(SourceAirtable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.SourceAirtable = SourceAirtable;
/** @internal */
SourceAirtable.__pulumiType = 'airbyte:index/sourceAirtable:SourceAirtable';
//# sourceMappingURL=sourceAirtable.js.map