...
export declare class SourceAirtable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAirtableState, opts?: pulumi.CustomResourceOptions): SourceAirtable;
    /**
     * Returns true if the given object is an instance of SourceAirtable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceAirtable;
    readonly configuration: pulumi.Output<outputs.SourceAirtableConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceAirtableResourceAllocation>;
    /**
...
export interface SourceAirtableState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceAirtableResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
