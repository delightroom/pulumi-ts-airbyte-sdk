...
export declare class SourceMssql extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMssqlState, opts?: pulumi.CustomResourceOptions): SourceMssql;
    /**
     * Returns true if the given object is an instance of SourceMssql.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceMssql;
    readonly configuration: pulumi.Output<outputs.SourceMssqlConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceMssqlResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceMssqlArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceMssql resources.
 */
export interface SourceMssqlState {
    configuration?: pulumi.Input<inputs.SourceMssqlConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceMssqlResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceMssqlArgs {
    configuration: pulumi.Input<inputs.SourceMssqlConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
