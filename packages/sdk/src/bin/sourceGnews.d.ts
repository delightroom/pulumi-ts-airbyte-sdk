...
export declare class SourceGnews extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceGnewsState, opts?: pulumi.CustomResourceOptions): SourceGnews;
    /**
     * Returns true if the given object is an instance of SourceGnews.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceGnews;
    readonly configuration: pulumi.Output<outputs.SourceGnewsConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceGnewsResourceAllocation>;
    /**
    ...
    /**
     * Create a SourceGnews resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SourceGnewsArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceGnews resources.
 */
export interface SourceGnewsState {
    configuration?: pulumi.Input<inputs.SourceGnewsConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceGnewsResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceGnewsArgs {
    configuration: pulumi.Input<inputs.SourceGnewsConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
