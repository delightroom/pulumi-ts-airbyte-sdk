...
exports.DestinationSftpJson = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationSftpJson extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationSftpJson(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(DestinationSftpJson.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.DestinationSftpJson = DestinationSftpJson;
/** @internal */
DestinationSftpJson.__pulumiType = 'airbyte:index/destinationSftpJson:DestinationSftpJson';
//# sourceMappingURL=destinationSftpJson.js.map