...
export declare class SourceBraintree extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceBraintreeState, opts?: pulumi.CustomResourceOptions): SourceBraintree;
    /**
     * Returns true if the given object is an instance of SourceBraintree.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceBraintree;
    readonly configuration: pulumi.Output<outputs.SourceBraintreeConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceBraintreeResourceAllocation>;
    /**
...
export interface SourceBraintreeState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceBraintreeResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
