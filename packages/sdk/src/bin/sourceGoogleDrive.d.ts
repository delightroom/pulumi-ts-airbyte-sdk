...
export declare class SourceGoogleDrive extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceGoogleDriveState, opts?: pulumi.CustomResourceOptions): SourceGoogleDrive;
    /**
     * Returns true if the given object is an instance of SourceGoogleDrive.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceGoogleDrive;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.SourceGoogleDriveConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceGoogleDriveResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceGoogleDriveArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceGoogleDrive resources.
 */
export interface SourceGoogleDriveState {
    /**
     * Used during spec; allows the developer to configure the cloud provider specific options that are needed when users
     * configure a file-based source.
     */
    configuration?: pulumi.Input<inputs.SourceGoogleDriveConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceGoogleDriveResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceGoogleDriveArgs {
    /**
     * Used during spec; allows the developer to configure the cloud provider specific options that are needed when users
     * configure a file-based source.
     */
