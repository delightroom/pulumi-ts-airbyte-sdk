...
exports.DestinationDevNull = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationDevNull extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationDevNull(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.DestinationDevNull = DestinationDevNull;
/** @internal */
DestinationDevNull.__pulumiType = 'airbyte:index/destinationDevNull:DestinationDevNull';
//# sourceMappingURL=destinationDevNull.js.map