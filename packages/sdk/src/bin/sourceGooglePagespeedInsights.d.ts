...
export declare class SourceGooglePagespeedInsights extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceGooglePagespeedInsightsResourceAllocation>;
    /**
...
export interface SourceGooglePagespeedInsightsState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceGooglePagespeedInsightsResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
