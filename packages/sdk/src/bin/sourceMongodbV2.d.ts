...
export declare class SourceMongodbV2 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMongodbV2State, opts?: pulumi.CustomResourceOptions): SourceMongodbV2;
    /**
     * Returns true if the given object is an instance of SourceMongodbV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceMongodbV2;
    readonly configuration: pulumi.Output<outputs.SourceMongodbV2Configuration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceMongodbV2ResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceMongodbV2Args, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceMongodbV2 resources.
 */
export interface SourceMongodbV2State {
    configuration?: pulumi.Input<inputs.SourceMongodbV2Configuration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceMongodbV2ResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceMongodbV2Args {
    configuration: pulumi.Input<inputs.SourceMongodbV2Configuration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
