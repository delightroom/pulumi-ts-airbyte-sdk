...
export declare class SourceMysql extends pulumi.CustomResource {
    ...
    readonly configuration: pulumi.Output<outputs.SourceMysqlConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceMysqlResourceAllocation>;
    /**
...
export interface SourceMysqlState {
    configuration?: pulumi.Input<inputs.SourceMysqlConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceMysqlResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
