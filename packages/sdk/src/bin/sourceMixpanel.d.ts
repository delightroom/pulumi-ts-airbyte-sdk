...
export declare class SourceMixpanel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMixpanelState, opts?: pulumi.CustomResourceOptions): SourceMixpanel;
    /**
     * Returns true if the given object is an instance of SourceMixpanel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceMixpanel;
    readonly configuration: pulumi.Output<outputs.SourceMixpanelConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceMixpanelResourceAllocation>;
    /**
     ...
     */
    constructor(name: string, args: SourceMixpanelArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceMixpanel resources.
 */
export interface SourceMixpanelState {
    configuration?: pulumi.Input<inputs.SourceMixpanelConfiguration>;
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.SourceMixpanelResourceAllocation>;
    /**
     * Optional secretID obtained through the public API OAuth redirect flow. Requires replacement if changed.
     */
 ...
 */
export interface SourceMixpanelArgs {
    configuration: pulumi.Input<inputs.SourceMixpanelConfiguration>;
    /**
     * The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
     * replacement if changed.
