...
exports.DestinationOracle = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationOracle extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationOracle(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(DestinationOracle.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.DestinationOracle = DestinationOracle;
/** @internal */
DestinationOracle.__pulumiType = 'airbyte:index/destinationOracle:DestinationOracle';
//# sourceMappingURL=destinationOracle.js.map