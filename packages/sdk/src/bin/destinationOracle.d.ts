...
export declare class DestinationOracle extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationOracleResourceAllocation>;
...
export interface DestinationOracleState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationOracleResourceAllocation>;
