...
exports.getSourceTrustpilot = getSourceTrustpilot;
exports.getSourceTrustpilotOutput = getSourceTrustpilotOutput;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
function getSourceTrustpilot(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("airbyte:index/getSourceTrustpilot:getSourceTrustpilot", {
        "sourceId": args.sourceId,
    }, opts, utilities.getPackage());
}
function getSourceTrustpilotOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
