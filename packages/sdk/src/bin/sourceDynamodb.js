...
exports.SourceDynamodb = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SourceDynamodb extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SourceDynamodb(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.SourceDynamodb = SourceDynamodb;
/** @internal */
SourceDynamodb.__pulumiType = 'airbyte:index/sourceDynamodb:SourceDynamodb';
//# sourceMappingURL=sourceDynamodb.js.map