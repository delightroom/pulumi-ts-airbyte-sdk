...
export declare class DestinationQdrant extends pulumi.CustomResource {
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.DestinationQdrantResourceAllocation>;
...
export interface DestinationQdrantState {
     ...
     * platform will use defaults. these values will be overriden by configuration at the connection level.
     */
    resourceAllocation?: pulumi.Input<inputs.DestinationQdrantResourceAllocation>;
