...
exports.DestinationMssql = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DestinationMssql extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DestinationMssql(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.DestinationMssql = DestinationMssql;
/** @internal */
DestinationMssql.__pulumiType = 'airbyte:index/destinationMssql:DestinationMssql';
//# sourceMappingURL=destinationMssql.js.map