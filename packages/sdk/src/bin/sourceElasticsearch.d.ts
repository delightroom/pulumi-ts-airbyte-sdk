...
export declare class SourceElasticsearch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceElasticsearchState, opts?: pulumi.CustomResourceOptions): SourceElasticsearch;
    /**
     * Returns true if the given object is an instance of SourceElasticsearch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceElasticsearch;
    readonly configuration: pulumi.Output<outputs.SourceElasticsearchConfiguration>;
     ...
     */
    readonly resourceAllocation: pulumi.Output<outputs.SourceElasticsearchResourceAllocation>;
    /**
