...
export function getDestinationQdrantOutput(args: GetDestinationQdrantOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationQdrantResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
