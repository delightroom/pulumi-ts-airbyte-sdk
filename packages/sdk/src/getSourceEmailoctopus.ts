...
export function getSourceEmailoctopusOutput(args: GetSourceEmailoctopusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceEmailoctopusResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
