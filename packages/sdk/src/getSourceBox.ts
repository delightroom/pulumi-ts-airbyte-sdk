...
export function getSourceBox(args: GetSourceBoxArgs, opts?: pulumi.InvokeOptions): Promise<GetSourceBoxResult> {
...
export function getSourceBoxOutput(args: GetSourceBoxOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceBoxResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
