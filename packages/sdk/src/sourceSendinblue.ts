...
export class SourceSendinblue extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceSendinblueState, opts?: pulumi.CustomResourceOptions): SourceSendinblue {
        return new SourceSendinblue(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceSendinblue:SourceSendinblue';

    /**
     * Returns true if the given object is an instance of SourceSendinblue.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceSendinblue {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceSendinblue.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceSendinblueConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceSendinblueResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceSendinblueArgs | SourceSendinblueState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceSendinblueState | undefined;
            ...
            const args = argsOrState as SourceSendinblueArgs | undefined;
        ...
        super(SourceSendinblue.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
