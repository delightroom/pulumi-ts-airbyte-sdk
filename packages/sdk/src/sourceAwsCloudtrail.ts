...
export class SourceAwsCloudtrail extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAwsCloudtrailState, opts?: pulumi.CustomResourceOptions): SourceAwsCloudtrail {
        return new SourceAwsCloudtrail(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceAwsCloudtrail:SourceAwsCloudtrail';

    /**
     * Returns true if the given object is an instance of SourceAwsCloudtrail.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceAwsCloudtrail {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceAwsCloudtrail.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceAwsCloudtrailConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceAwsCloudtrailResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceAwsCloudtrailArgs | SourceAwsCloudtrailState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceAwsCloudtrailState | undefined;
            ...
            const args = argsOrState as SourceAwsCloudtrailArgs | undefined;
        ...
        super(SourceAwsCloudtrail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
