...
export class SourceAsana extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAsanaState, opts?: pulumi.CustomResourceOptions): SourceAsana {
        return new SourceAsana(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceAsana:SourceAsana';

    /**
     * Returns true if the given object is an instance of SourceAsana.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceAsana {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceAsana.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceAsanaConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceAsanaResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceAsanaArgs | SourceAsanaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceAsanaState | undefined;
            ...
            const args = argsOrState as SourceAsanaArgs | undefined;
        ...
        super(SourceAsana.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
