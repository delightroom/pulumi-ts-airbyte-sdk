...
export function getDestinationS3GlueOutput(args: GetDestinationS3GlueOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationS3GlueResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
