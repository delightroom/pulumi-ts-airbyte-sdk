...
export function getDestinationDatabricksOutput(args: GetDestinationDatabricksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationDatabricksResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
