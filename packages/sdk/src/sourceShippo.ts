...
export class SourceShippo extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceShippoState, opts?: pulumi.CustomResourceOptions): SourceShippo {
        return new SourceShippo(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceShippo:SourceShippo';

    /**
     * Returns true if the given object is an instance of SourceShippo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceShippo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceShippo.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceShippoConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceShippoResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceShippoArgs | SourceShippoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceShippoState | undefined;
            ...
            const args = argsOrState as SourceShippoArgs | undefined;
        ...
        super(SourceShippo.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
