...
export class DestinationSnowflakeCortex extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationSnowflakeCortexState, opts?: pulumi.CustomResourceOptions): DestinationSnowflakeCortex {
        return new DestinationSnowflakeCortex(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationSnowflakeCortex:DestinationSnowflakeCortex';
     ...
     */
    public static isInstance(obj: any): obj is DestinationSnowflakeCortex {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationSnowflakeCortex.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.DestinationSnowflakeCortexConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationSnowflakeCortexResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationSnowflakeCortexArgs | DestinationSnowflakeCortexState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationSnowflakeCortexState | undefined;
            ...
            const args = argsOrState as DestinationSnowflakeCortexArgs | undefined;
        ...
        super(DestinationSnowflakeCortex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
