...
export class SourceChameleon extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceChameleonState, opts?: pulumi.CustomResourceOptions): SourceChameleon {
        return new SourceChameleon(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceChameleon:SourceChameleon';

    /**
     * Returns true if the given object is an instance of SourceChameleon.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceChameleon {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceChameleon.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceChameleonConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceChameleonResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceChameleonArgs | SourceChameleonState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceChameleonState | undefined;
            ...
            const args = argsOrState as SourceChameleonArgs | undefined;
        ...
        super(SourceChameleon.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
