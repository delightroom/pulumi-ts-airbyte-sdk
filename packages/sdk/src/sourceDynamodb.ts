...
export class SourceDynamodb extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceDynamodb:SourceDynamodb';
    ...
    public readonly configuration!: pulumi.Output<outputs.SourceDynamodbConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceDynamodbResourceAllocation>;
    /**
