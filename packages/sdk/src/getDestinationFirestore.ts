...
export function getDestinationFirestoreOutput(args: GetDestinationFirestoreOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationFirestoreResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
