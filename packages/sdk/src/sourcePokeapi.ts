...
export class SourcePokeapi extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourcePokeapiState, opts?: pulumi.CustomResourceOptions): SourcePokeapi {
        return new SourcePokeapi(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourcePokeapi:SourcePokeapi';

    /**
     * Returns true if the given object is an instance of SourcePokeapi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourcePokeapi {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourcePokeapi.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourcePokeapiConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourcePokeapiResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourcePokeapiArgs | SourcePokeapiState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourcePokeapiState | undefined;
            ...
            const args = argsOrState as SourcePokeapiArgs | undefined;
        ...
        super(SourcePokeapi.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
