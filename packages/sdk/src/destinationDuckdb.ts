...
export class DestinationDuckdb extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationDuckdbState, opts?: pulumi.CustomResourceOptions): DestinationDuckdb {
        return new DestinationDuckdb(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationDuckdb:DestinationDuckdb';

    /**
     * Returns true if the given object is an instance of DestinationDuckdb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationDuckdb {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationDuckdb.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationDuckdbConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationDuckdbResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationDuckdbArgs | DestinationDuckdbState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationDuckdbState | undefined;
            ...
            const args = argsOrState as DestinationDuckdbArgs | undefined;
        ...
        super(DestinationDuckdb.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
