...
export function getSourceWhiskyHunterOutput(args: GetSourceWhiskyHunterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceWhiskyHunterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
