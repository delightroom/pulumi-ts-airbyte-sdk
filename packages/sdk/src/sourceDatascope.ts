...
export class SourceDatascope extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceDatascopeState, opts?: pulumi.CustomResourceOptions): SourceDatascope {
        return new SourceDatascope(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceDatascope:SourceDatascope';

    /**
     * Returns true if the given object is an instance of SourceDatascope.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceDatascope {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceDatascope.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceDatascopeConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceDatascopeResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceDatascopeArgs | SourceDatascopeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceDatascopeState | undefined;
            ...
            const args = argsOrState as SourceDatascopeArgs | undefined;
        ...
        super(SourceDatascope.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
