...
export function getSourceGoogleDriveOutput(args: GetSourceGoogleDriveOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceGoogleDriveResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
