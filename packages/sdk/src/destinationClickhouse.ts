...
export class DestinationClickhouse extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationClickhouse:DestinationClickhouse';
    ...
    public readonly configuration!: pulumi.Output<outputs.DestinationClickhouseConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationClickhouseResourceAllocation>;
