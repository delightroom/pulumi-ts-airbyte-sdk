...
export class DestinationYellowbrick extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationYellowbrickState, opts?: pulumi.CustomResourceOptions): DestinationYellowbrick {
        return new DestinationYellowbrick(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationYellowbrick:DestinationYellowbrick';

    /**
     * Returns true if the given object is an instance of DestinationYellowbrick.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationYellowbrick {
    ...
    public readonly configuration!: pulumi.Output<outputs.DestinationYellowbrickConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationYellowbrickResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationYellowbrickArgs | DestinationYellowbrickState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationYellowbrickState | undefined;
            ...
            const args = argsOrState as DestinationYellowbrickArgs | undefined;
