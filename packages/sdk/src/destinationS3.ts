...
export class DestinationS3 extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationS3State, opts?: pulumi.CustomResourceOptions): DestinationS3 {
        return new DestinationS3(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationS3:DestinationS3';

    /**
     * Returns true if the given object is an instance of DestinationS3.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationS3 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationS3.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationS3Configuration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationS3ResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationS3Args | DestinationS3State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationS3State | undefined;
            ...
            const args = argsOrState as DestinationS3Args | undefined;
        ...
        super(DestinationS3.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
