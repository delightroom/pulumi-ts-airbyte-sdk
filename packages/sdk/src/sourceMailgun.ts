...
export class SourceMailgun extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMailgunState, opts?: pulumi.CustomResourceOptions): SourceMailgun {
        return new SourceMailgun(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceMailgun:SourceMailgun';

    /**
     * Returns true if the given object is an instance of SourceMailgun.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceMailgun {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceMailgun.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceMailgunConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceMailgunResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceMailgunArgs | SourceMailgunState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceMailgunState | undefined;
            ...
            const args = argsOrState as SourceMailgunArgs | undefined;
        ...
        super(SourceMailgun.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
