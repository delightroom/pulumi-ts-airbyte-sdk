...
export class SourceTinyemail extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTinyemailState, opts?: pulumi.CustomResourceOptions): SourceTinyemail {
        return new SourceTinyemail(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceTinyemail:SourceTinyemail';

    /**
     * Returns true if the given object is an instance of SourceTinyemail.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceTinyemail {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceTinyemail.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceTinyemailConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceTinyemailResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceTinyemailArgs | SourceTinyemailState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceTinyemailState | undefined;
            ...
            const args = argsOrState as SourceTinyemailArgs | undefined;
        ...
        super(SourceTinyemail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
