...
export class DestinationVectara extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationVectaraState, opts?: pulumi.CustomResourceOptions): DestinationVectara {
        return new DestinationVectara(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationVectara:DestinationVectara';

    /**
     * Returns true if the given object is an instance of DestinationVectara.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationVectara {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationVectara.__pulumiType;
    }

    /**
     * Configuration to connect to the Vectara instance
     */
    public readonly configuration!: pulumi.Output<outputs.DestinationVectaraConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationVectaraResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationVectaraArgs | DestinationVectaraState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationVectaraState | undefined;
            ...
            const args = argsOrState as DestinationVectaraArgs | undefined;
        ...
        super(DestinationVectara.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
