...
export class SourceOutbrainAmplify extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceOutbrainAmplifyState, opts?: pulumi.CustomResourceOptions): SourceOutbrainAmplify {
        return new SourceOutbrainAmplify(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceOutbrainAmplify:SourceOutbrainAmplify';

    /**
     * Returns true if the given object is an instance of SourceOutbrainAmplify.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceOutbrainAmplify {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceOutbrainAmplify.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceOutbrainAmplifyConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceOutbrainAmplifyResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceOutbrainAmplifyArgs | SourceOutbrainAmplifyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceOutbrainAmplifyState | undefined;
            ...
            const args = argsOrState as SourceOutbrainAmplifyArgs | undefined;
        ...
        super(SourceOutbrainAmplify.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
