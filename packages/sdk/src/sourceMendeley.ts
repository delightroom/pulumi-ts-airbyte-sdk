...
export class SourceMendeley extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMendeleyState, opts?: pulumi.CustomResourceOptions): SourceMendeley {
        return new SourceMendeley(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceMendeley:SourceMendeley';

    /**
     * Returns true if the given object is an instance of SourceMendeley.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceMendeley {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceMendeley.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceMendeleyConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceMendeleyResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceMendeleyArgs | SourceMendeleyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceMendeleyState | undefined;
            ...
            const args = argsOrState as SourceMendeleyArgs | undefined;
        ...
        super(SourceMendeley.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
