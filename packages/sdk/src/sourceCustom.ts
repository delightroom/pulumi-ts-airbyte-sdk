...
export class SourceCustom extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceCustomState, opts?: pulumi.CustomResourceOptions): SourceCustom {
        return new SourceCustom(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceCustom:SourceCustom';

    /**
     * Returns true if the given object is an instance of SourceCustom.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceCustom {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceCustom.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SourceCustomArgs | SourceCustomState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as SourceCustomArgs | undefined;
        ...
        super(SourceCustom.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
