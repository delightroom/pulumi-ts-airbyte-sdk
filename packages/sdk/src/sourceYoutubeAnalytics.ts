...
export class SourceYoutubeAnalytics extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceYoutubeAnalyticsState, opts?: pulumi.CustomResourceOptions): SourceYoutubeAnalytics {
        return new SourceYoutubeAnalytics(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceYoutubeAnalytics:SourceYoutubeAnalytics';

    /**
     * Returns true if the given object is an instance of SourceYoutubeAnalytics.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceYoutubeAnalytics {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceYoutubeAnalytics.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceYoutubeAnalyticsConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceYoutubeAnalyticsResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceYoutubeAnalyticsArgs | SourceYoutubeAnalyticsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceYoutubeAnalyticsState | undefined;
            ...
            const args = argsOrState as SourceYoutubeAnalyticsArgs | undefined;
        ...
        super(SourceYoutubeAnalytics.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
