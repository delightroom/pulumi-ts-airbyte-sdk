...
export class SourceToggl extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTogglState, opts?: pulumi.CustomResourceOptions): SourceToggl {
        return new SourceToggl(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceToggl:SourceToggl';

    /**
     * Returns true if the given object is an instance of SourceToggl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceToggl {
    ...
    public readonly configuration!: pulumi.Output<outputs.SourceTogglConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceTogglResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceTogglArgs | SourceTogglState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceTogglState | undefined;
            ...
            const args = argsOrState as SourceTogglArgs | undefined;
