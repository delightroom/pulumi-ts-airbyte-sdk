...
export class DestinationTeradata extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationTeradataState, opts?: pulumi.CustomResourceOptions): DestinationTeradata {
        return new DestinationTeradata(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationTeradata:DestinationTeradata';

    /**
     * Returns true if the given object is an instance of DestinationTeradata.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationTeradata {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationTeradata.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationTeradataConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationTeradataResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationTeradataArgs | DestinationTeradataState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationTeradataState | undefined;
            ...
            const args = argsOrState as DestinationTeradataArgs | undefined;
        ...
        super(DestinationTeradata.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
