...
export class SourceCoda extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceCodaState, opts?: pulumi.CustomResourceOptions): SourceCoda {
        return new SourceCoda(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceCoda:SourceCoda';

    /**
     * Returns true if the given object is an instance of SourceCoda.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceCoda {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceCoda.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceCodaConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceCodaResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceCodaArgs | SourceCodaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceCodaState | undefined;
            ...
            const args = argsOrState as SourceCodaArgs | undefined;
        ...
        super(SourceCoda.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
