...
export class SourceTheGuardianApi extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTheGuardianApiState, opts?: pulumi.CustomResourceOptions): SourceTheGuardianApi {
        return new SourceTheGuardianApi(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceTheGuardianApi:SourceTheGuardianApi';

    /**
     * Returns true if the given object is an instance of SourceTheGuardianApi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceTheGuardianApi {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceTheGuardianApi.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceTheGuardianApiConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceTheGuardianApiResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceTheGuardianApiArgs | SourceTheGuardianApiState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceTheGuardianApiState | undefined;
            ...
            const args = argsOrState as SourceTheGuardianApiArgs | undefined;
        ...
        super(SourceTheGuardianApi.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
