...
export class SourceSftpBulk extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceSftpBulkState, opts?: pulumi.CustomResourceOptions): SourceSftpBulk {
        return new SourceSftpBulk(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceSftpBulk:SourceSftpBulk';

    /**
     * Returns true if the given object is an instance of SourceSftpBulk.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceSftpBulk {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceSftpBulk.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.SourceSftpBulkConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceSftpBulkResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceSftpBulkArgs | SourceSftpBulkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceSftpBulkState | undefined;
            ...
            const args = argsOrState as SourceSftpBulkArgs | undefined;
        ...
        super(SourceSftpBulk.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
