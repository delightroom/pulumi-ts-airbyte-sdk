...
export class SourceMongodbV2 extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceMongodbV2State, opts?: pulumi.CustomResourceOptions): SourceMongodbV2 {
        return new SourceMongodbV2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceMongodbV2:SourceMongodbV2';

    /**
     * Returns true if the given object is an instance of SourceMongodbV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceMongodbV2 {
    ...
    public readonly configuration!: pulumi.Output<outputs.SourceMongodbV2Configuration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceMongodbV2ResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceMongodbV2Args | SourceMongodbV2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceMongodbV2State | undefined;
            ...
            const args = argsOrState as SourceMongodbV2Args | undefined;
