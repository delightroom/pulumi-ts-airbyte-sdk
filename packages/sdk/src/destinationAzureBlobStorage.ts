...
export class DestinationAzureBlobStorage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationAzureBlobStorageState, opts?: pulumi.CustomResourceOptions): DestinationAzureBlobStorage {
        return new DestinationAzureBlobStorage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationAzureBlobStorage:DestinationAzureBlobStorage';
     ...
     */
    public static isInstance(obj: any): obj is DestinationAzureBlobStorage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationAzureBlobStorage.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationAzureBlobStorageConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationAzureBlobStorageResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationAzureBlobStorageArgs | DestinationAzureBlobStorageState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationAzureBlobStorageState | undefined;
            ...
            const args = argsOrState as DestinationAzureBlobStorageArgs | undefined;
        ...
        super(DestinationAzureBlobStorage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
