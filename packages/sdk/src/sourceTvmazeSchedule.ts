...
export class SourceTvmazeSchedule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTvmazeScheduleState, opts?: pulumi.CustomResourceOptions): SourceTvmazeSchedule {
        return new SourceTvmazeSchedule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceTvmazeSchedule:SourceTvmazeSchedule';

    /**
     * Returns true if the given object is an instance of SourceTvmazeSchedule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceTvmazeSchedule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceTvmazeSchedule.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceTvmazeScheduleConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceTvmazeScheduleResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceTvmazeScheduleArgs | SourceTvmazeScheduleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceTvmazeScheduleState | undefined;
            ...
            const args = argsOrState as SourceTvmazeScheduleArgs | undefined;
        ...
        super(SourceTvmazeSchedule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
