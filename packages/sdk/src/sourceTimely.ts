...
export class SourceTimely extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceTimelyState, opts?: pulumi.CustomResourceOptions): SourceTimely {
        return new SourceTimely(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceTimely:SourceTimely';

    /**
     * Returns true if the given object is an instance of SourceTimely.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceTimely {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceTimely.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceTimelyConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceTimelyResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceTimelyArgs | SourceTimelyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceTimelyState | undefined;
            ...
            const args = argsOrState as SourceTimelyArgs | undefined;
        ...
        super(SourceTimely.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
