...
export class SourceAuth0 extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAuth0State, opts?: pulumi.CustomResourceOptions): SourceAuth0 {
        return new SourceAuth0(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceAuth0:SourceAuth0';

    /**
     * Returns true if the given object is an instance of SourceAuth0.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceAuth0 {
    ...
    public readonly configuration!: pulumi.Output<outputs.SourceAuth0Configuration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceAuth0ResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceAuth0Args | SourceAuth0State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceAuth0State | undefined;
            ...
            const args = argsOrState as SourceAuth0Args | undefined;
