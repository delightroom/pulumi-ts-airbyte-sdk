...
export class DestinationMilvus extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationMilvusState, opts?: pulumi.CustomResourceOptions): DestinationMilvus {
        return new DestinationMilvus(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationMilvus:DestinationMilvus';

    /**
     * Returns true if the given object is an instance of DestinationMilvus.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationMilvus {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationMilvus.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.DestinationMilvusConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationMilvusResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationMilvusArgs | DestinationMilvusState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationMilvusState | undefined;
            ...
            const args = argsOrState as DestinationMilvusArgs | undefined;
        ...
        super(DestinationMilvus.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
