...
export class DestinationFirebolt extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationFireboltState, opts?: pulumi.CustomResourceOptions): DestinationFirebolt {
        return new DestinationFirebolt(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationFirebolt:DestinationFirebolt';

    /**
     * Returns true if the given object is an instance of DestinationFirebolt.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationFirebolt {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationFirebolt.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationFireboltConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationFireboltResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationFireboltArgs | DestinationFireboltState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationFireboltState | undefined;
            ...
            const args = argsOrState as DestinationFireboltArgs | undefined;
        ...
        super(DestinationFirebolt.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
