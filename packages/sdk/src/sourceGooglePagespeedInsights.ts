...
export class SourceGooglePagespeedInsights extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceGooglePagespeedInsightsState, opts?: pulumi.CustomResourceOptions): SourceGooglePagespeedInsights {
        return new SourceGooglePagespeedInsights(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceGooglePagespeedInsights:SourceGooglePagespeedInsights';
     ...
     */
    public static isInstance(obj: any): obj is SourceGooglePagespeedInsights {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceGooglePagespeedInsights.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceGooglePagespeedInsightsConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceGooglePagespeedInsightsResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceGooglePagespeedInsightsArgs | SourceGooglePagespeedInsightsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceGooglePagespeedInsightsState | undefined;
            ...
            const args = argsOrState as SourceGooglePagespeedInsightsArgs | undefined;
        ...
        super(SourceGooglePagespeedInsights.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
