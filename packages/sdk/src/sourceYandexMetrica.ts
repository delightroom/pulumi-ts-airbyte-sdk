...
export class SourceYandexMetrica extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceYandexMetricaState, opts?: pulumi.CustomResourceOptions): SourceYandexMetrica {
        return new SourceYandexMetrica(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceYandexMetrica:SourceYandexMetrica';

    /**
     * Returns true if the given object is an instance of SourceYandexMetrica.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceYandexMetrica {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceYandexMetrica.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SourceYandexMetricaArgs | SourceYandexMetricaState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as SourceYandexMetricaArgs | undefined;
        ...
        super(SourceYandexMetrica.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
