...
export class DestinationPubsub extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationPubsubState, opts?: pulumi.CustomResourceOptions): DestinationPubsub {
        return new DestinationPubsub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/destinationPubsub:DestinationPubsub';

    /**
     * Returns true if the given object is an instance of DestinationPubsub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DestinationPubsub {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DestinationPubsub.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.DestinationPubsubConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.DestinationPubsubResourceAllocation>;
    ...
    constructor(name: string, argsOrState?: DestinationPubsubArgs | DestinationPubsubState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DestinationPubsubState | undefined;
            ...
            const args = argsOrState as DestinationPubsubArgs | undefined;
        ...
        super(DestinationPubsub.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
