...
export class SourceGoogleDrive extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceGoogleDriveState, opts?: pulumi.CustomResourceOptions): SourceGoogleDrive {
        return new SourceGoogleDrive(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceGoogleDrive:SourceGoogleDrive';

    /**
     * Returns true if the given object is an instance of SourceGoogleDrive.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceGoogleDrive {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceGoogleDrive.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.SourceGoogleDriveConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceGoogleDriveResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceGoogleDriveArgs | SourceGoogleDriveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceGoogleDriveState | undefined;
            ...
            const args = argsOrState as SourceGoogleDriveArgs | undefined;
        ...
        super(SourceGoogleDrive.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
