...
export class SourceConfigcat extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceConfigcatState, opts?: pulumi.CustomResourceOptions): SourceConfigcat {
        return new SourceConfigcat(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceConfigcat:SourceConfigcat';

    /**
     * Returns true if the given object is an instance of SourceConfigcat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceConfigcat {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceConfigcat.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceConfigcatConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceConfigcatResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceConfigcatArgs | SourceConfigcatState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceConfigcatState | undefined;
            ...
            const args = argsOrState as SourceConfigcatArgs | undefined;
        ...
        super(SourceConfigcat.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
