...
export function getSourcePostmarkappOutput(args: GetSourcePostmarkappOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourcePostmarkappResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
