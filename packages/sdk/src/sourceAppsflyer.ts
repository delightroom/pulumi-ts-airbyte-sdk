...
export class SourceAppsflyer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAppsflyerState, opts?: pulumi.CustomResourceOptions): SourceAppsflyer {
        return new SourceAppsflyer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceAppsflyer:SourceAppsflyer';

    /**
     * Returns true if the given object is an instance of SourceAppsflyer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceAppsflyer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceAppsflyer.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceAppsflyerConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceAppsflyerResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceAppsflyerArgs | SourceAppsflyerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceAppsflyerState | undefined;
            ...
            const args = argsOrState as SourceAppsflyerArgs | undefined;
        ...
        super(SourceAppsflyer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
