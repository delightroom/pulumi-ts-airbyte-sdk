...
export function getSourceAzureBlobStorageOutput(args: GetSourceAzureBlobStorageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceAzureBlobStorageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
