...
export function getDestinationTeradataOutput(args: GetDestinationTeradataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDestinationTeradataResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
