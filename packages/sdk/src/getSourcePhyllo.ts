...
export function getSourcePhyllo(args: GetSourcePhylloArgs, opts?: pulumi.InvokeOptions): Promise<GetSourcePhylloResult> {
...
export function getSourcePhylloOutput(args: GetSourcePhylloOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourcePhylloResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
