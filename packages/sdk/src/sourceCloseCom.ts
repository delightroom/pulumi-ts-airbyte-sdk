...
export class SourceCloseCom extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceCloseComState, opts?: pulumi.CustomResourceOptions): SourceCloseCom {
        return new SourceCloseCom(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'airbyte:index/sourceCloseCom:SourceCloseCom';

    /**
     * Returns true if the given object is an instance of SourceCloseCom.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SourceCloseCom {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SourceCloseCom.__pulumiType;
    }

    public readonly configuration!: pulumi.Output<outputs.SourceCloseComConfiguration>;
     ...
     */
    public /*out*/ readonly resourceAllocation!: pulumi.Output<outputs.SourceCloseComResourceAllocation>;
    /**
    ...
    constructor(name: string, argsOrState?: SourceCloseComArgs | SourceCloseComState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SourceCloseComState | undefined;
            ...
            const args = argsOrState as SourceCloseComArgs | undefined;
        ...
        super(SourceCloseCom.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
