...
export function getSourcePaypalTransactionOutput(args: GetSourcePaypalTransactionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourcePaypalTransactionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
