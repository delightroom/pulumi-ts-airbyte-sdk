...
export function getSourceLaunchdarklyOutput(args: GetSourceLaunchdarklyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSourceLaunchdarklyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
