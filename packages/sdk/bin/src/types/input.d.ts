...
export interface DestinationMssqlConfigurationTunnelMethod {
    noTunnel?: pulumi.Input<inputs.DestinationMssqlConfigurationTunnelMethodNoTunnel>;
    passwordAuthentication?: pulumi.Input<inputs.DestinationMssqlConfigurationTunnelMethodPasswordAuthentication>;
    sshKeyAuthentication?: pulumi.Input<inputs.DestinationMssqlConfigurationTunnelMethodSshKeyAuthentication>;
}
...
export interface DestinationS3GlueConfigurationFormat {
    jsonLinesNewlineDelimitedJson?: pulumi.Input<inputs.DestinationS3GlueConfigurationFormatJsonLinesNewlineDelimitedJson>;
}
export interface DestinationS3GlueConfigurationFormatJsonLinesNewlineDelimitedJson {
    /**
     * Whether the output files should be compressed. If compression is selected, the output filename will have an extra extension (GZIP: ".jsonl.gz").
     */
    compression?: pulumi.Input<inputs.DestinationS3GlueConfigurationFormatJsonLinesNewlineDelimitedJsonCompression>;
    /**
...
export interface DestinationS3GlueConfigurationFormatJsonLinesNewlineDelimitedJsonCompression {
    gzip?: pulumi.Input<inputs.DestinationS3GlueConfigurationFormatJsonLinesNewlineDelimitedJsonCompressionGzip>;
    noCompression?: pulumi.Input<inputs.DestinationS3GlueConfigurationFormatJsonLinesNewlineDelimitedJsonCompressionNoCompression>;
}
...
export interface SourceAzureBlobStorageConfigurationStreamFormat {
     ...
     */
    documentFileTypeFormatExperimental?: pulumi.Input<inputs.SourceAzureBlobStorageConfigurationStreamFormatDocumentFileTypeFormatExperimental>;
...
export interface SourceAzureBlobStorageConfigurationStreamFormatDocumentFileTypeFormatExperimental {
     ...
     */
    processing?: pulumi.Input<inputs.SourceAzureBlobStorageConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing>;
    /**
...
export interface SourceAzureBlobStorageConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
     ...
     */
    local?: pulumi.Input<inputs.SourceAzureBlobStorageConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingLocal>;
}
...
export interface SourceGoogleDriveConfigurationStreamFormat {
     ...
     * Extract text from document formats (.pdf, .docx, .md, .pptx) and emit as one record per file.
     */
    documentFileTypeFormatExperimental?: pulumi.Input<inputs.SourceGoogleDriveConfigurationStreamFormatDocumentFileTypeFormatExperimental>;
...
export interface SourceGoogleDriveConfigurationStreamFormatDocumentFileTypeFormatExperimental {
     ...
     * Processing configuration
     */
    processing?: pulumi.Input<inputs.SourceGoogleDriveConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing>;
    /**
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync. Default: true
     */
    skipUnprocessableFiles?: pulumi.Input<boolean>;
...
export interface SourceGoogleDriveConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
     ...
     * Process files locally, supporting `fast` and `ocr` modes. This is the default option.
     */
    local?: pulumi.Input<inputs.SourceGoogleDriveConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingLocal>;
}
...
export interface SourceMysqlConfigurationReplicationMethod {
     ...
     */
    readChangesUsingBinaryLogCdc?: pulumi.Input<inputs.SourceMysqlConfigurationReplicationMethodReadChangesUsingBinaryLogCdc>;
    /**
     * Incrementally detects new inserts and updates using the <a href="https://docs.airbyte.com/understanding-airbyte/connections/incremental-append/#user-defined-cursor">cursor column</a> chosen when configuring a connection (e.g. created_at, updated_at).
     */
