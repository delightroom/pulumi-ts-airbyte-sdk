...
export declare class SourceAmplitude extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceAmplitudeState, opts?: pulumi.CustomResourceOptions): SourceAmplitude;
    /** @internal */
    static readonly __pulumiType = "airbyte:index/sourceAmplitude:SourceAmplitude";
    /**
     * Returns true if the given object is an instance of SourceAmplitude.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceAmplitude;
    readonly configuration: pulumi.Output<outputs.SourceAmplitudeConfiguration>;
    /**
...
//# sourceMappingURL=sourceAmplitude.d.ts.map