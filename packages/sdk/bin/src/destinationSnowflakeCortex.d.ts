...
export declare class DestinationSnowflakeCortex extends pulumi.CustomResource {
    /**
     * Get an existing DestinationSnowflakeCortex resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationSnowflakeCortexState, opts?: pulumi.CustomResourceOptions): DestinationSnowflakeCortex;
    /** @internal */
    static readonly __pulumiType = "airbyte:index/destinationSnowflakeCortex:DestinationSnowflakeCortex";
    /**
     * Returns true if the given object is an instance of DestinationSnowflakeCortex.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationSnowflakeCortex;
    /**
     ...
     */
    constructor(name: string, args: DestinationSnowflakeCortexArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering DestinationSnowflakeCortex resources.
 */
export interface DestinationSnowflakeCortexState {
    /**
     * The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
     * configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
     * model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
 ...
 */
export interface DestinationSnowflakeCortexArgs {
    /**
     * The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
     * configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
     * model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
...
//# sourceMappingURL=destinationSnowflakeCortex.d.ts.map