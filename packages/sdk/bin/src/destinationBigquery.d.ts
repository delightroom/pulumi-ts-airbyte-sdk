...
export declare class DestinationBigquery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationBigqueryState, opts?: pulumi.CustomResourceOptions): DestinationBigquery;
    /** @internal */
    static readonly __pulumiType = "airbyte:index/destinationBigquery:DestinationBigquery";
    /**
...
//# sourceMappingURL=destinationBigquery.d.ts.map