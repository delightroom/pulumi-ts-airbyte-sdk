...
export declare class SourceCustom extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SourceCustomState, opts?: pulumi.CustomResourceOptions): SourceCustom;
    /** @internal */
    static readonly __pulumiType = "airbyte:index/sourceCustom:SourceCustom";
    /**
     * Returns true if the given object is an instance of SourceCustom.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SourceCustom;
    /**
    ...
    /**
     * Create a SourceCustom resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SourceCustomArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SourceCustom resources.
 */
export interface SourceCustomState {
    /**
     * The values required to configure the source. Parsed as JSON.
     */
 ...
 */
export interface SourceCustomArgs {
    /**
     * The values required to configure the source. Parsed as JSON.
     */
    configuration: pulumi.Input<string>;
...
//# sourceMappingURL=sourceCustom.d.ts.map