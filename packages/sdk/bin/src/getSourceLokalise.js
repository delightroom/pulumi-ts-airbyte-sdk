...
exports.getSourceLokalise = getSourceLokalise;
exports.getSourceLokaliseOutput = getSourceLokaliseOutput;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("./utilities"));
function getSourceLokalise(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("airbyte:index/getSourceLokalise:getSourceLokalise", {
        "sourceId": args.sourceId,
    }, opts, utilities.getPackage());
}
function getSourceLokaliseOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
