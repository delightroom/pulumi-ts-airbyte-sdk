...
export declare class DestinationS3Glue extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationS3GlueState, opts?: pulumi.CustomResourceOptions): DestinationS3Glue;
    /** @internal */
    static readonly __pulumiType = "airbyte:index/destinationS3Glue:DestinationS3Glue";
    /**
     * Returns true if the given object is an instance of DestinationS3Glue.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationS3Glue;
    readonly configuration: pulumi.Output<outputs.DestinationS3GlueConfiguration>;
    /**
...
//# sourceMappingURL=destinationS3Glue.d.ts.map