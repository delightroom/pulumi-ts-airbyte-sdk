...
export declare class DestinationGcs extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DestinationGcsState, opts?: pulumi.CustomResourceOptions): DestinationGcs;
    /** @internal */
    static readonly __pulumiType = "airbyte:index/destinationGcs:DestinationGcs";
    /**
     * Returns true if the given object is an instance of DestinationGcs.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DestinationGcs;
    readonly configuration: pulumi.Output<outputs.DestinationGcsConfiguration>;
    /**
...
//# sourceMappingURL=destinationGcs.d.ts.map