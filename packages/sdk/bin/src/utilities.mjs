...
export function getEnvBoolean(...vars) {
    const s = getEnv(...vars);
    if (s !== undefined) {
...
export function getEnvNumber(...vars) {
    const s = getEnv(...vars);
    if (s !== undefined) {
...
/** @internal */
export function resourceOptsDefaults() {
    return { version: getVersion() };
}
/** @internal */
export function lazyLoad(exports, props, loadModule) {
...
export async function callAsync(tok, props, res, opts) {
